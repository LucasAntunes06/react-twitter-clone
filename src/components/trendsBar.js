...
export default function TrendsBar() {
    return (
        ...
        w-4/12 bg-black border-l border-border text-white">
            ...
            flex flex-col items-start">
                <h1 className="text-xl font-extrabold px-4 py-3
                text-white">O que está acontecendo</h1>
                ...
                cursor-pointer">
                    <i className="bi bi-three-dots text-xl text-text-search
                     font-light mr-2 align-top right-8 absolute
                     hover:bg-twitter-blue-2 py-1 px-2 rounded-full"></i>
                ...
                <div className="py-3  bg-trends hover:bg-trends-hover w-full 
                rounded-b-xl">
